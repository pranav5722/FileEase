...
import { HEIGHT, imageFormats, Poppins_600SemiBold, reExt, SIZE } from '../utils/Constants';
      ...
      <View style={styles.topButtons}>
        ...
        <View style={styles.buttons}>
          <TouchableOpacity onPress={() => setNewFileActionSheet(true)}>
            <MaterialCommunityIcons name="file-import" size={28} color={colors.primary} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => setFolderDialogVisible(true)}>
            <MaterialCommunityIcons name="folder-plus" size={28} color={colors.primary} />
          </TouchableOpacity>
        </View>
        {multiSelect && (
